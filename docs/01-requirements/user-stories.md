...
## Epic 12: Account Lifecycle

| ID      | User Story                                                                                       | Status |
| ------- | ------------------------------------------------------------------------------------------------ | ------ |
| US-12.1 | As a newly registered user, I want to verify my email from a link so that my account is trusted. | DONE |
| US-12.2 | As a user, I want to resend verification email when needed so that I can complete account activation. | DONE |
| US-12.3 | As an authenticated user, I want to change my password so that I can maintain account security. | DONE |
