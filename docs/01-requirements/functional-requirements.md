...
| 10.8    | 2026-04-02 | Codex  | Corrected FR-AU-008 back to PENDING after reviewing the underlying auth/session scope: remember-me persistence shipped, but the broader documented session-management capability is not yet fully implemented. |
