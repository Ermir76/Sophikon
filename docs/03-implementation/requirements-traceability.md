...
- `A3` Project and insights surface: `backend/app/api/v1/endpoints/projects.py`, `backend/app/api/v1/endpoints/insights.py`, `frontend/src/features/projects/*`, `frontend/src/features/dashboard/*`, `frontend/src/app/App.tsx`
...
| FR-PM-005 | Partial | A3 | Project overview insights exist, but not the exact `/dashboard` surface described in the requirement. |
...
| US-1.4 Project Dashboard | Partial | A3 | Dashboard and project-overview insights exist, but not full parity with every acceptance item. |
